...
<div class="w-5/12 bg-white p-5 rounded-lg">
    <form action="{{route('register')}}" method="POST">
        ...
        <div class="mb-5">
            ...
            class="bg-blue-100 border-2 w-full p-3 rounded-lg @error('name') border-red-500 @enderror" value="{{old('name')}}">
        ...
        <div class="mb-5">
            ...
            class="bg-blue-100 border-2 w-full p-3 rounded-lg @error('username') border-red-500 @enderror" value="{{old('username')}}">
